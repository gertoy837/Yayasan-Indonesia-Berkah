                            ...
                            <div class="col-lg-6 mb-1 mt-4">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <button class="btn btn-outline-secondary sort-button" data-sort-by="nama_santri"
                                            data-sort-order="asc">
                                            <i class="fas fa-sort-alpha-down"></i> Nama
                                        </button>
                                        <button class="btn btn-outline-secondary sort-button"
                                            data-sort-by="tgllahir_santri" data-sort-order="asc">
                                            <i class="fas fa-sort-numeric-down"></i> Tanggal Lahir
                                        </button>
                                        <button class="btn btn-outline-secondary sort-button"
                                            data-sort-by="angkatan_santri" data-sort-order="asc">
                                                        ...
                                                        <div class="thumb">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4 col-sm-4 d-none d-sm-block">
                                                                    <p class="teks1 mt-2">{{ $item->angkatan_santri }}
                                                                    </p>
                                                                </div>
                                                                <div class="col-lg-4 col-sm-4 col-12">
                                                                    <h4>{{ $item->nama_santri }}</h4>
                                                                    <p class="teks1 date">{{ $item->tgllahir_santri }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="client-content mt-2">
                                                                            ...
                                                                            <p class="dika">“Lorem ipsum dolor sit
                                                                                amet, consectetur adpiscing elit, sed do
                                                                                eismod tempor idunte ut labore et dolore
                                                                                magna aliqua darwin kengan lorem ipsum
                                                                                dolor sit amet, consectetur picing elit
                                                                                massive big blasta.”</p>
                                                                        </div>
                                                                        <div
                                                                            class="d-flex down-content justify-items-between">
                                                                            @if ($item->photo_santri)
                                                                                <img src="{{ asset('storage/images/' . $item->photo_santri) }}"
                                                                                    alt="Foto Santri" class="img-fluid">
                                                                            @else
                                                                            ...
                                                                            <div class="col-lg-6 mt-4 ml-4">
                                                                                ...
                                                                                <h4 class="dika">
                                                                                    {{ $item->nama_santri }}</h4>
                                                                                <p class="dika">
                                                                                    {{ $item->angkatan_santri }}</p>
                                                                                <a class="btn btn-warning bg-warning mt-1"
                                                                                    href="{{ route('detailsantri', $item->id) }}">Detail</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
