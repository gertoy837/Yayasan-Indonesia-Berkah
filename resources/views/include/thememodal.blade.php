                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-6 col-md-3 theme-option" data-theme="forest" onclick="selectTheme(this)">
                            <div class="theme-preview"
                                style="background-image: url('template/dist/assets/images/bulan.jpg');"></div>
                        </div>
                        <div class="col-6 col-md-3 theme-option" data-theme="snow" onclick="selectTheme(this)">
                            <div class="theme-preview"
                                style="background-image: url('template/dist/assets/images/salju.jpg');"></div>
                        </div>
                        <div class="col-6 col-md-3 theme-option" data-theme="ricefield" onclick="selectTheme(this)">
                            <div class="theme-preview"
                                style="background-image: url('template/dist/assets/images/pemandangan1.jpg');"></div>
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            ...
                            <input type="file" class="hidden-input" id="customThemeInput" accept="image/*"
                                onchange="previewCustomTheme()">
                        </div>
                    </div>
                </div>
            </div>
