            ...
            <div class="container mt-3">
                <div class="col-lg-8 ">
                    <div class="input-group mb-2" style="">
                        <input type="text" id="search" class="form-control" name="keyword" placeholder="Telusuri Data Santri" style="background-color: rgba(243, 243, 243, 0.341); border-radius:20px; color: white;">
                    </div>
                </div>
            </div>
                ...
                <div class="dropdown">
                    <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="user-menu d-flex"> 
                            ...
                            <div class="ms-3 name">
                                <h6 class="font-bold mt-2">{{ Auth::user()->name }}</h6>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end x-slot" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                        ...
                        <li><hr><center><div type="button" class="btn btn-primary" data-toggle="modal" data-target="#themeModal">
                            Pilih Tema
                          </div></center></li>
                        <li>
                            <hr>
