...
html, body {
    ...
    .form-control::placeholder {
            color: white;
            opacity: 1; /* Mengatur opacity jika dibutuhkan */
        }
   ...
   #clients {
    ...
    top: 0;
        ...
        .theme-forest { background-image: url('template/dist/assets/images/malam.jpg'); }
        .theme-snow { background-image: url('template/dist/assets/images/salju.jpg'); }
        .theme-ricefield { background-image: url('template/dist/assets/images/pemandangan.jpg'); }
