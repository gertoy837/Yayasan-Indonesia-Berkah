            ...
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    ...
                    @if (Auth::user()->role == 'admin')
                        <a href="{{ route('admindashboard') }}" class="btn btn-lg btn-outline-primary mt-3">Go Back</a>
                    @elseif (Auth::user()->role == 'santri')
                    <a href="{{ route('santridashboard') }}" class="btn btn-lg btn-outline-primary mt-3">Go Back</a>
                    @endif
                </div>
            </div>
        </div>
