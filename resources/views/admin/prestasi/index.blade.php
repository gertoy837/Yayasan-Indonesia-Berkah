                                        ...
                                        <tbody >
                                            ...
                                            <tr id="prestasi-list">
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-warning rounded-pill m-2" href="{{route('admineditprestasi',$item->id)}}"><i class="fa fa-solid fa-pen"></i></a>
                                                    <a class="btn btn-light rounded-pill m-2" href="{{route('adminhapusprestasi',$item->id)}}" onclick="return confirm('Mau Dihapus?!')"><i class="fa fa-solid fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                                $no++;
