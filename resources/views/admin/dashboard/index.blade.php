            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="bar"></div>
                                <button id="close-calendar calendar-container" style="margin: 10px; display:none;">Close</button>
                                <div id="calendar"></div>
            ...
            fetch(`/get-dates-by-month/${month}`)
                ...
                .then(data => {
                    ...
                    calendar = new FullCalendar.Calendar(calendarEl, {
                        ...
                        initialDate: moment().month(month - 1).format('YYYY-MM-DD'), // Set the initial date to the selected month
                        headerToolbar: {
