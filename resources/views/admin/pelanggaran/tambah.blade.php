                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <h4 class="card-title mb-4">Masukkan Data Pelanggaran Santri
                                                        </h4>
                                                        <div class="row">
                                                            <div class="col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="santri_id" id="santri_id"
                                                                        ...
                                                                        <option hidden>Pilih Santri</option>
                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                <div class="mb-3">
                                                                    <label for="katP">Kategori
                                                                        Pelanggaran</label>
                                                                    <select class="form-select" id="katP"
                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label for="ketP">Keterangan
                                                                        Pelanggaran</label>
                                                                    <input type="text" id="ketP"
                                                                        class="form-control"
                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                <label for="tglpelanggaran">Tanggal</label>
