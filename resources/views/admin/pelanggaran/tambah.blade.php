                                                ...
                                                <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                ...
                                                                <input name="tglpelanggaran" id="tglpelanggaran" type="date" class="form-control flatpickr-no-config" placeholder="Select date..">
                                                            </div>
                                                            
                                                            <div class="col-12 d-flex justify-content-end">
                                                                <button type="submit" class="btn btn-primary me-1 mb-1">Submit</button>
                                                                <a href="{{ route('adminpelanggaran') }}" type="reset" class="btn btn-light-secondary me-1 mb-1">Kembali</a>
                                                            </div>
                                                        </div>
                                                </div>
                                            </div>
