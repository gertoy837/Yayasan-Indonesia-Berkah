...
class PrestasiController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('santrii.prestasi.tambah', compact('query','querysantri'));
    }
    ...
    public function import(Request $request)
{
    ...
    public function show(string $id)
    {
        ...
        return view('santrii.prestasi.detail', compact('prestasi'));
    }
    ...
    public function edit($id)
    {
        ...
        $query = Prestasi::with('Santri')->get();
        $querysantri = Santri::all();
        return view('santrii.prestasi.edit', compact('edit', 'query', 'querysantri'));
    }
